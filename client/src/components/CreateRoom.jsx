          ...
          <div className="p-8 md:p-12 space-y-8">
            <div className="text-center">
              ...
              <p className="text-slate-400">
                Create or join a secure virtual courtroom
              </p>
            </div>
            ...
            <button
              onClick={create}
              disabled={loading}
              className="w-full bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
            >
              {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
              <Feature title="HD Video" />
              <Feature title="Peer-to-Peer" />
